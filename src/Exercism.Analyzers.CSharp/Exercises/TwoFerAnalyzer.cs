...
internal class TwoFerAnalyzer : ExerciseAnalyzer
{
    ...
    internal static class Comments
    {
        ...
        public static readonly Comment UseStringInterpolationNotStringJoin = new("csharp.two-fer.use_string_interpolation_not_string_join", CommentType.Actionable);
        public static readonly Comment UseStringInterpolationNotStringConcat = new("csharp.two-fer.use_string_interpolation_not_string_concat", CommentType.Actionable);
        public static readonly Comment UseNullCoalescingOperatorNotIsNullOrEmptyCheck = new("csharp.two-fer.use_null_coalescing_operator_not_is_null_or_empty", CommentType.Actionable);
        public static readonly Comment UseNullCoalescingOperatorNotIsNullOrWhiteSpaceCheck = new("csharp.two-fer.use_null_coalescing_operator_not_is_null_or_white_space", CommentType.Actionable);
        public static readonly Comment UseDefaultValueNotOverloads = new("csharp.two-fer.use_default_value_not_overloads", CommentType.Essential);
        ...
        public static Comment InvalidDefaultValue(string parameterName, string defaultValue) =>
            new("csharp.two-fer.invalid_default_value", CommentType.Actionable, new CommentParameter("name", parameterName), new CommentParameter("value", defaultValue));
    }
}
