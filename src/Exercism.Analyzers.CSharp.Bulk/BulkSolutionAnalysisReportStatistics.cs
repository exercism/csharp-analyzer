...
namespace Exercism.Analyzers.CSharp.Bulk
{
    internal static class BulkSolutionAnalysisReportStatistics
    {
        ...
        private const int StatisticsMaximumColumnWidth = 6;
        private const int StatisticsMinimumColumnWidth = 6;
        ...
        private static StringBuilder AddStatisticsHeader(this StringBuilder report) =>
            report
                ...
                .AppendLine($"| {"Status",StatisticsStatusColumnWidth} | {"Count",StatisticsCountColumnWidth} | {"Comments",StatisticsCommentsColumnWidth} | {"Avg",StatisticsAverageColumnWidth} | {"Max",StatisticsMaximumColumnWidth} | {"Min",StatisticsMinimumColumnWidth} |")
                .AppendLine($"| {"".PadRight(StatisticsStatusColumnWidth, '-')}:| {"".PadRight(StatisticsCountColumnWidth, '-')}:| {"".PadRight(StatisticsCommentsColumnWidth, '-')}:| {"".PadRight(StatisticsAverageColumnWidth, '-')}:| {"".PadRight(StatisticsMaximumColumnWidth, '-')}:| {"".PadRight(StatisticsMinimumColumnWidth, '-')}:|");
        ...
        private static StringBuilder AddStatisticsForStatus(this StringBuilder report,
            ...
            report.AppendLine($"| {status,StatisticsStatusColumnWidth} | {statistics.Count,StatisticsCountColumnWidth} | {statistics.CommentsWithCount.Count,StatisticsCommentsColumnWidth} | {statistics.Performance.AverageInMilliseconds,4:#0}ms | {statistics.Performance.MaximumInMilliseconds,4:#0}ms | {statistics.Performance.MinimumInMilliseconds,4:#0}ms | ");
    }
}